...
cp -r build/derived_data/Build/Products/Release-iphoneos/*.a build/GosuSDK/iphoneos
cp -r build/derived_data/Build/Products/Release-iphoneos/GSinSDK_include build/GosuSDK/iphoneos
...
cp -r build/derived_data/Build/Products/Release-iphonesimulator/*.a build/GosuSDK/simulators
cp -r build/derived_data/Build/Products/Release-iphonesimulator/GSinSDK_include build/GosuSDK/simulators
rm -rf build/derived_data/Build/Products/Release-iphonesimulator
...
cp -r build/derived_data/Build/Products/Release-iphoneos/SDKDataResource.bundle build/GosuSDK/iphoneos/SDKDataResource.bundle
