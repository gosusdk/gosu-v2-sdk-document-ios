...
#import "NulledResponse.h"

@interface GamoGrpcApi : NSObject<ServerConnectionDelegate>
...
//social login
- (void) requestLoginByFacebook:(SdkConfig *)SdkConfig andFacebookLoginResult:(NSDictionary *)facebookLoginResult andLoginResponseCallback:(void (^)(RequestLoginResponse *))loginResponseCallback;
